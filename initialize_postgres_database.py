...
from abstrag.embedding import (
    PaperEmbedding,
    ChunkParams,
    chunk_document,
    document_embedding,
)
from abstrag.utils.path_resolver import find_file, find_env_file
...
# Find CSV files in standard locations
METADATA_PATH = find_file("metadata_all.csv", script_dir=script_dir)
MARKDOWN_ARTICLES_PATH = find_file("article_markdown.csv", script_dir=script_dir)
