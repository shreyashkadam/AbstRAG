...
from abstrag.llm import llm_chat_completion, GroqParams, build_rag_prompt, GroqModels
...
try:
    env_path = find_env_file("local_env", script_dir=script_dir)
except FileNotFoundError:
    try:
        env_path = find_env_file(".env", script_dir=script_dir)
    except FileNotFoundError:
        env_path = "./local_env"  # Fallback

environment = dotenv_values(env_path)

# Find evaluation questions file
PATH_EVALUATION_QUESTIONS = find_evaluation_questions_file(
